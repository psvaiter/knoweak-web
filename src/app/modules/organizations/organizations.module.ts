...
import { OrganizationAnalysisModalComponent } from './organization-analyses/organization-analysis-modal/organization-analysis-modal.component';
...
@NgModule({
    declarations: [
        ...
        OrganizationAnalysisDetailComponent,
